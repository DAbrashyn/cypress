...
const signUp = '.hero-descriptor_btn'
  ...
  it('Check Do more!', () => {
     ...
     cy.contains('.hero-descriptor_descr', 'With the help of the Hillel auto project, you will have the opportunity to get hands-on experience in manual testing.').should('be.visible');
